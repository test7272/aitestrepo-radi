...
- **0 best-effort fallbacks remain** for obscure languages with no known example anywhere in the database — every language ships a file, per the author's requirement.
...
16 real entry-point programs under `src/` import or load **every single dependency** the manifests declare:
