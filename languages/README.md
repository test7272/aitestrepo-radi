...
| Ada | programming | template | ci_executed | `gnatmake hafu.adb -o /tmp/hello_ada && /tmp/hello_ada` |
...
| AMPL | programming | template | not_ci_executed | `ampl qevugo.ampl` |
...
| Asymptote | programming | template | not_ci_executed | `asy puwu.asy` |
| ATS | programming | template | not_ci_executed | `patscc feni.dats` |
...
| Awk | programming | template | ci_executed | `awk -f paxo.awk /dev/null` |
...
| Batchfile | programming | template | not_ci_executed | `cmd mohopiko.bat` |
...
| C | programming | template | ci_executed | `gcc juxehepo.c -o /tmp/hello_c && /tmp/hello_c` |
| C-ObjDump | data | document | source | `valid data document` |
| C# | programming | template | ci_executed | `cd languages/csharp && dotnet run` |
| C++ | programming | template | ci_executed | `g++ jozymu.cpp -o /tmp/hello_cpp && /tmp/hello_cpp` |
| C2hs Haskell | programming | template | not_ci_executed | `-` |
| C3 | programming | template | not_ci_executed | `c3c cedy.c3` |
...
| Ceylon | programming | template | not_ci_executed | `ceylon rakohyva.ceylon` |
| Chapel | programming | template | not_ci_executed | `chpl bevi.chpl` |
...
| Clean | programming | template | not_ci_executed | `clm xedipyny.icl` |
...
| CoffeeScript | programming | template | not_ci_executed | `coffee tuho.coffee` |
...
| Common Lisp | programming | template | ci_executed | `clisp coreno.lisp` |
...
| Csound | programming | template | not_ci_executed | `csound hypaja.orc` |
...
| Cython | programming | template | not_ci_executed | `cython bezefy.pyx` |
...
| Dafny | programming | template | not_ci_executed | `dafny tyfija.dfy` |
| Darcs Patch | data | document | source | `valid data document` |
| Dart | programming | template | not_ci_executed | `dart zyhisy.dart` |
...
| Dockerfile | programming | template | not_ci_executed | `docker ninuviki.dockerfile` |
...
| Elixir | programming | template | ci_executed | `elixir kodoso.ex` |
| Elm | programming | template | not_ci_executed | `-` |
| Elvish | programming | template | not_ci_executed | `elvish jikeso.elv` |
| Elvish Transcript | programming | hand-written | source | `source (toolchain required)` |
| Emacs Lisp | programming | template | not_ci_executed | `emacs --batch pube.el` |
...
| Erlang | programming | template | ci_executed | `escript vupiqywy.erl` |
| Euphoria | programming | hello-world | source | `source (toolchain required)` |
| F* | programming | template | not_ci_executed | `-` |
| F# | programming | template | ci_executed | `cd languages/fsharp && dotnet fsi vedoquxy.fs` |
| Factor | programming | template | not_ci_executed | `factor jepyzi.factor` |
...
| Fennel | programming | template | not_ci_executed | `fennel cawoligi.fnl` |
...
| fish | programming | template | not_ci_executed | `fish qoje.fish` |
...
| Forth | programming | template | ci_executed | `gforth cive.fth -e bye` |
| Fortran | programming | template | ci_executed | `gfortran xypy.f90 -o /tmp/hello_f90 && /tmp/hello_f90` |
...
| Futhark | programming | template | not_ci_executed | `futhark fixywu.fut` |
...
| GDScript | programming | template | not_ci_executed | `godot gily.gd` |
...
| Go | programming | template | ci_executed | `go run dova.go` |
...
| Groovy | programming | template | ci_executed | `groovy cugedeqo.groovy` |
...
| Haskell | programming | template | ci_executed | `runghc nuceji.hs` |
...
| Hy | programming | template | not_ci_executed | `hy lyfo.hy` |
...
| Idris | programming | template | not_ci_executed | `idris cife.idr` |
...
| Io | programming | template | not_ci_executed | `io bose.io` |
...
| J | programming | template | not_ci_executed | `jconsole paza.ijs` |
...
| Janet | programming | template | not_ci_executed | `janet byteryga.janet` |
...
| Java | programming | template | ci_executed | `java behili.java` |
...
| JavaScript | programming | template | ci_executed | `node gajahe.js` |
...
| Julia | programming | template | ci_executed | `julia kuci.jl` |
...
| LiveScript | programming | template | not_ci_executed | `livescript ladolohy.ls` |
...
| Lua | programming | template | ci_executed | `lua5.4 qivufixu.lua` |
...
| MATLAB | programming | template | not_ci_executed | `octave caqe.m` |
...
| Mercury | programming | template | not_ci_executed | `mmc tafa.m` |
...
| NetLogo | programming | template | not_ci_executed | `netlogo city.nlogo` |
| NewLisp | programming | template | not_ci_executed | `newlisp wucuho.nl` |
| Nextflow | programming | template | not_ci_executed | `nextflow fibune.nf` |
...
| OCaml | programming | template | ci_executed | `ocaml pyzubeve.ml` |
| Odin | programming | template | not_ci_executed | `odin vode.odin` |
...
| OpenSCAD | programming | template | not_ci_executed | `openscad dobewopo.scad` |
...
| Pascal | programming | template | ci_executed | `fpc rumi.pas -o/tmp/hello_pas >/dev/null && /tmp/hello_pas` |
...
| Perl | programming | template | ci_executed | `perl gomixeho.pl` |
| PHP | programming | template | ci_executed | `php kifibuni.php` |
...
| Pony | programming | template | not_ci_executed | `pony qyjaba.pony` |
...
| PowerShell | programming | template | not_ci_executed | `pwsh puwano.ps1` |
...
| Prolog | programming | template | ci_executed | `swipl -q -g "main" -t halt -f sisenewa.pro` |
...
| Puppet | programming | template | not_ci_executed | `puppet myzi.pp` |
| Pure Data | data | hello-world | source | `source (toolchain required)` |
| PureBasic | programming | template | not_ci_executed | `-` |
| PureScript | programming | template | not_ci_executed | `purs fyvydy.purs` |
| Pyret | programming | hello-world | source | `source (toolchain required)` |
| Python | programming | template | ci_executed | `python3 wyju.py` |
...
| R | programming | template | ci_executed | `Rscript vesaheki.R` |
| Racket | programming | template | ci_executed | `racket mywizy.rkt` |
...
| Red | programming | template | not_ci_executed | `red nadifo.red` |
...
| REXX | programming | template | not_ci_executed | `rexx piba.rexx` |
...
| Ring | programming | template | not_ci_executed | `ring qeqoqico.ring` |
...
| Ruby | programming | template | ci_executed | `ruby dijeme.rb` |
| RUNOFF | markup | document | source | `valid markup document` |
| Rust | programming | template | ci_executed | `rustc siwewuxi.rs -o /tmp/hello_rs && /tmp/hello_rs` |
...
| SAS | programming | template | not_ci_executed | `sas qowe.sas` |
...
| Scheme | programming | template | ci_executed | `guile roly.scm` |
| Scilab | programming | template | not_ci_executed | `scilab hypa.sci` |
| SCSS | markup | hello-world | source | `source (toolchain required)` |
| sed | programming | template | ci_executed | `echo foo | sed -f jywaqy.sed` |
...
| Shell | programming | template | ci_executed | `bash jemewo.sh` |
...
| Smalltalk | programming | template | not_ci_executed | `gst lyniqine.st` |
...
| Snakemake | programming | template | not_ci_executed | `snakemake wohu.smk` |
| Solidity | programming | template | not_ci_executed | `solc dubymise.sol` |
...
| SQL | data | template | ci_executed | `sqlite3 :memory: < vyguky.sql` |
| SQLPL | programming | hand-written | source | `source (toolchain required)` |
| Squirrel | programming | template | not_ci_executed | `squirrel loceja.nut` |
...
| Stata | programming | template | not_ci_executed | `stata saqyla.do` |
...
| SystemVerilog | programming | template | not_ci_executed | `iverilog wyvaxu.sv` |
...
| Tcl | programming | template | ci_executed | `tclsh fomavy.tcl` |
...
| Terra | programming | template | not_ci_executed | `terra nojapi.t` |
...
| TypeScript | programming | template | ci_executed | `npx --yes tsc fyti.ts && node fyti.js` |
...
| Vala | programming | template | ci_executed | `valac baha.vala -o /tmp/hello_vala && /tmp/hello_vala` |
...
| YARA | programming | template | not_ci_executed | `yara lovyxega.yar` |
...
| Zeek | programming | template | not_ci_executed | `zeek husoqi.zeek` |
